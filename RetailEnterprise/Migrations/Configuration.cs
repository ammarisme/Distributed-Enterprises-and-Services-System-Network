namespace RetailEnterprise.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RetailEnterprise.DAL.ApplicationDbContext>
    {
        ...
        protected override void Seed(RetailEnterprise.DAL.ApplicationDbContext db)
        {
            ...
            if (db.Suppliers.Count() < 3)
            {
                Supplier vendor1 = new Supplier { SupplierId = "1", SupplierName = "Default" };
                Supplier vendor2 = new Supplier { SupplierId = "2", SupplierName = "Supplier 3" };
                Supplier vendor3 = new Supplier { SupplierId = "3", SupplierName = "Supplier 3" };

                db.Suppliers.Add(vendor1);
                db.Suppliers.Add(vendor2);
                db.Suppliers.Add(vendor3);
            }
