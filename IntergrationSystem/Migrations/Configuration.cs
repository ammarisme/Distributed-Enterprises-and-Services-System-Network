namespace IntegrationSystem.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<IntegrationSystem.DAL.ApplicationDbContext>
    {
        ...
        protected override void Seed(IntegrationSystem.DAL.ApplicationDbContext db)
        {
