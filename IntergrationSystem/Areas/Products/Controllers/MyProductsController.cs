...
using System.IO;
namespace IntegrationSystem.Areas.Products.Controllers
{
    ...
    public class MyProductsController : Controller
    {
        ...
        /*
         *@purpose - Showing a View where a product can be created.
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.location = "MyProducts > Create new Product";
            return View();
        }
            ...
            try
            {
                foreach (string fileName in Request.Files)
                {
                    ...
                    if (file != null && file.ContentLength > 0)
                    {
                        ...
                        string pathString = System.IO.Path.Combine(originalDirectory.ToString(), "temporary");
