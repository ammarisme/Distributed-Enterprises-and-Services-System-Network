...
namespace IntegrationSystem.Areas.Accounts.Models
{
    ...
    public class RegisterAccountDataModel : AddAccountViewModel
    {
    ...
    {
        public List<Service> ServiceStatuses { get; set; }

        public List<Enterprise> EnterpriseStatuses { get; set; }
    }
}
