...
using IntegrationSystem.Areas.PurchaseOrders.Models;

namespace IntegrationSystem.Areas.PurchaseOrders.Controllers
{
    ...
    public class MyPurchaseOrdersController : Controller
    {
        ...
        public ActionResult AddPurchaseOrder()
        {
            ...
            createWholesaleOrder.SupplierId = db.Retailers;
        ...
        //    string userId = User.Identity.GetUserId();
        //    placeOrderModel.Retailer = db.Retailers.Find(userId);
