...
namespace RetailTradingPortal.DAL
     ...
     */
{
     ...
     * 
     * Database Name - RetailTradingPortal1
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        public ApplicationDbContext()
            : base("Data Source=.\\SQLEXPRESS;Initial Catalog=RetailTradingPortal1;Integrated Security=True", throwIfV1Schema: false)
        {
